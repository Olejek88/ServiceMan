...
import ru.shtrm.serviceman.db.migration.Migration14;
...
import ru.shtrm.serviceman.db.migration.Migration25;
import ru.shtrm.serviceman.db.migration.Migration26;
...
//            }
        ...
        if (oldVersion == 13) {
            new Migration14().migration(realm);
            oldVersion++;
        }

        if (oldVersion == 14) {
            new Migration15().migration(realm);
            oldVersion++;
        }

        if (oldVersion == 15) {
            new Migration16().migration(realm);
            oldVersion++;
        }
        ...
        if (oldVersion == 24) {
            new Migration25().migration(realm);
            oldVersion++;
        }
